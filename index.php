...
<div class="navigation-bar dark fixed-top shadow">
    <div class="navigation-bar-content container">
        <a href="/" class="element"><span class="icon-home"></span> 911Shooter <sup>.com</sup></a>
        ...
        <ul class="element-menu">
            ...
            <li>
                <a  href="#"><span class="icon-user"></span> DJ Profile</a>
            </li>
            <li>
            ...
            <li>
                <a  href="#"><span class="icon-github"></span> สมัคร DJ</a>
            </li>
